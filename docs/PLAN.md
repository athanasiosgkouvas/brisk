...
| Move package (testnet)       | `0xcbd54ab52fad4110fdad2d9fd8e92e84dd87db436f2b608cc47819f7d4fd03cc` (fresh republish 2026-06-04; 5 modules)      |
| ↳ upgrade (`record_payment`) | `0x3ac880a1eab2763fc1b92376a88e1913d0bc4dbf02023a3c0a0321d16c2837cb` (carries `payment_receipt::record_payment`)  |
| LendingPool<USDC>            | `0xdd22637b26c052aedd2ab234a62d52d607e3fe381cc2181768b154f25c2023b8` (10% APY, 10% reserve factor; seeded 2 USDC) |
| mock_lender AdminCap         | `0x9b8c70e7f429a8b90d01bcfed5397b12415d21e780a8b3aa16d806b118272ecd`                                              |
| UpgradeCap                   | `0x987d97f8e5e7dbc32ed3f3777d928673dfbfcc567646ae99d3813a4a6162165e`                                              |
| Deployments record           | `move/deployments.json` (authoritative — supersedes any ids quoted in this living doc)                            |
...
- `spending_vault.move` — Save bucket; deposit (adds shares)/withdraw (redeem+split+re-supply); value-conservation invariant. **(DONE)**
- `lender_adapter.move` — adapter interface (testnet↔mainnet seam); supply/supply_into/redeem/current_value/principal. **(DONE)**
- `mock_lender.move` — cToken/share money market (compounding exchange_rate + reserve_factor → reserves + claim_reserves; graceful redeem). **(DONE — no longer a stub)**
